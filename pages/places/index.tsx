  ...
  return (
    <div>
      ...
      <ul className="flex gap-10 pl-7 mt-10">
        <li>
      <label htmlFor="location" className="block mb-2 text-base font-medium text-gray-900 dark:text-white">Select a location</label>
      <select id="location"
      ...
      <li>
      <label htmlFor="price" className="block mb-2 text-base font-medium text-gray-900 dark:text-white">Select a price</label>
      <select
      id="price"
